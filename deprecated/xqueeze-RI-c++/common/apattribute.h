...
/** \file apattribute.h
 *  \brief Interface specification for attribute of type APAttibute
 */

#ifndef XQML_APATTRIBUTE_H
#define XQML_APATTRIBUTE_H
...
namespace xqMLImpl
{
  //! The APAttribute attribute
  class APAttribute: public xqMLImpl::Attribute
  {
  private:
    xqML::xqMLSymbol vasymbol_;
  };
