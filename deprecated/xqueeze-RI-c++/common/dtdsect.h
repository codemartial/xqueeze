...
/** \file dtdsect.h
 *  \brief Interface for the DTDSect Unit
 */

#ifndef XQML_DTDSECT_H
#define XQML_DTDDECT_H
...
namespace xqMLImpl
{
  //! Unit for holding the inline DTD in a document
  class DTDSect: public xqMLImpl::Unit
  {
  private:
    std::string dtd_;
  };
