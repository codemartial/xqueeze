...
/** \file elstag.h
 *  \brief Interface specification for Unit EL_STag
 */

#ifndef XQML_ELSTAG_H
#define XQML_ELSTAG_H

#include <common/starttag>

namespace xqMLImpl
{
  //! The Element Start Tag syntactic Unit
  class EL_STag: public xqMLImpl::StartTag
  {
  };
