...
/** \file entityref.h
 *  \brief Interface for Unit EntityRef
 */

#ifndef XQML_ENTITYREF_H
#define XQML_ENTITYREF_H
...
namespace xqMLImpl
{
  //! The Entity Reference syntactic Unit
  class EntityRef: public xqMLImpl::Reference
  {
  private:
    xqML::xqMLSymbol ensymbol_;
  };
}
#endif
