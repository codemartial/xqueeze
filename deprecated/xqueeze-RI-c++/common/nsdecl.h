...
/** \file nsdecl.h
 *  \brief Interface for Unit NSDecl
 */

#ifndef XQML_NSDECL_H
#define XQML_NSDECL_H
...
namespace xqMLImpl
{
  //! The Namespace Declaration syntactic Unit
  class NSDecl: public xqMLImpl::Unit
  {
  private:
    xqMLSymbol nssymbol_;
    std::string nsuri_;
  };
}
#endif
