...
/** \file nsprefix.h
 *  \brief Interface specification for Unit NSPrefix
 */

#ifndef XQML_NSPREFIX_H
#define XQML_NSPREFIX_H
...
namespace xqMLImpl
{
  //! The Namespace Prefix syntactic Unit
  class NSPrefix: public xqMLImpl::Unit
  {
  private:
    xqML::xqMLSymbol nssymbol_;
  };
}
#endif
