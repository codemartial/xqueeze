...
/** \file reference.h
 *  \brief Interface specification for Unit Reference
 */

#ifndef XQML_REFERENCE_H
#define XQML_REFERENCE_H

#include <common/chardata.h>

namespace xqMLImpl
{
  //! The Reference (Character/Entity) syntactic Unit
  class Reference: public xqMLImpl::CharData
  {
    Reference();
    virtual ~Reference();
  };
