...
/** \file domparser.h
 *  \brief Interface specification for a DOM Parser
 */

#ifndef XQML_DOMPARSER_H
#define XQML_DOMPARSER_H

namespace xqML 
{
  
  //! A Parser offering DOM interface for parsing documents
  class DOMParser: public xqML::Parser, public xqML::DOM 
  {
  };
