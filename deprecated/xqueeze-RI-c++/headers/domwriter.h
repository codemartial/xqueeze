...
/** \file domwriter.h
 *  \brief Interface specification for a DOM-based Writer
 */

#ifndef XQML_DOMWRITER_H
#define XQML_DOMWRITER_H

namespace xqML 
{
  
  //! A Writer offering the DOM interface for generation of documents
  class DOMWriter: public xqML::Writer, public xqML::DOM 
  {
  };
