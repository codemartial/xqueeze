...
#ifndef XQML_XQAGENERATOR_IMPL_H
#define XQML_XQAGENERATOR_IMPL_H
#include <iostream>
#include <string>
#include <set>
...
namespace xqMLxqAGen {
  ...
  {
  private:
    typedef std::set<string> IdGroup;
    IdGroup ELs; //!< Element identifiers
    IdGroup EEs; //!< Empty Element identifiers
    IdGroup ATs; //!< Attribute identifiers
    IdGroup APs; //!< Attribute WPV identifiers
    IdGroup VAs; //!< Enumerated Attribute Value identifiers
    IdGroup ENs; //!< Entity Reference identifiers
    istream & dtd;
    ostream & xqa;
    string buffer;
